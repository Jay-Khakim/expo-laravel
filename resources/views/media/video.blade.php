...
@section('language')
    <li>
        <a href="{{route('video', 'en') }}"><img src="/images/icon/1.jpg" alt="English language icon"><span>@lang("En")</span></a>
    </li>
    <li>
        <a href="{{route('video', 'ru') }}"><img src="/images/icon/2.jpg" alt="Russian language icon"><span>@lang("Ru")</span></a>
    </li>
    <li>
        <a href="{{route('video', 'uz') }}"><img src="/images/icon/3.jpg" alt="Uzbek Language Icon"><span>@lang("Uz")</span></a>
    </li>
@endsection
                    ...
                    <div class="page-title-heading">
                        <div class="breadcrumbs">
                            <ul class="trail-items">
                                ...
                                <li class="trail-end">@lang("Video")</li>
                            </ul>                   
                        </div>
                                        ...
                                        <article class="blog-post">
                                            <div class="entry-wrapper">
                                                <div class="entry-header">
                                                    <h4 class="entry-time">
                                                        <span class="entry-day">{{$video->created_at->format('d')}}</span>
                                                        <span class="entry-month">
                                                            @if ($video->created_at->format('m') == 1)
                                                                @lang("Jan")
                                                            @endif
                                                            @if ($video->created_at->format('m') == 2)
                                                                @lang("Feb")
                                                            @endif
                                                            @if ($video->created_at->format('m') == 3)
                                                                @lang("Mar")
                                                            @endif
                                                            @if ($video->created_at->format('m') == 4)
                                                                @lang("Apr")
                                                            @endif
                                                            @if ($video->created_at->format('m') == 5)
                                                                @lang("May")
                                                            @endif
                                                            @if ($video->created_at->format('m') == 6)
                                                                @lang("Jun")
                                                            @endif
                                                            @if ($video->created_at->format('m') == 7)
                                                                @lang("Jul")
                                                            @endif
                                                            @if ($video->created_at->format('m') == 8)
                                                                @lang("Aug")
                                                            @endif
                                                            @if ($video->created_at->format('m') == 9)
                                                                @lang("Sep")
                                                            @endif
                                                            ...
                                                            @if ($video->created_at->format('m') == 11)
                                                                @lang("Nov")
                                                            @endif
                                                            @if ($video->created_at->format('m') == 12)
                                                                @lang("Dec")
                                                            @endif
                                                        </span>
                                                        <span class="entry-year">{{$video->created_at->format('Y')}}</span>
                                                    </h4>
                                                    <div class="entry-header-content">
                                                        ...
                                                        <div class="entry-meta">
                                                            ...
                                                            <span class="entry-comments-link"><a href="javascript:void(0)">0 Комментария</a></span> --}}
                                                        </div>
